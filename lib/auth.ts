          ...
          <tr>
            <td style="padding: 36px 32px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 14px; color: #a1a1aa; line-height: 22px; text-align: center;">
                Welcome to OAGPT, <strong style="color: #ffffff;">${name || "there"}</strong>! Please confirm your email address to activate your account and log in.
              </p>
              ...
              <p style="margin: 24px 0 0 0; font-size: 13px; color: #71717a; line-height: 20px; text-align: center;">
                Once verified, you will be redirected to log in with your email or username.
              </p>
